<template>
	<div class="rolesettings">
		...
		<div id="sousuo">
			<el-collapse v-model="activeNames" @change="handleChange">
				<el-collapse-item title="搜索列表" name="2" id="lie">
					<el-row :gutter="10">
						<el-col class="row" :xs="12" :sm="12" :md="12" :lg="12" :xl="5">
						...
						<el-col class="row" :xs="12" :sm="12" :md="12" :lg="12" :xl="5">
							<div class="input-group">
								...
								<select class="xl" v-model="groupingId" v-on:change="fuwufenzu($event)">
			...
			<el-table ref="multipleTable" :data="tableData3" height="632" tooltip-effect="dark" style="width: 100%">
				...
				<el-table-column label="操作" width="120">
					<template slot-scope="scope">
						...
						<el-button type="text" size="small" @click="showModals(scope.$index,tableData3)" v-show="role.isShowUpdate">修改</el-button>
					</template>
				</el-table-column>
			</el-table>
		</div>
		...
		<modals v-show="isModalVisibles" @close="closeModals" v-on:closes="serlf" v-on:close="serlfs" v-bind:shujus="shuju" v-bind:businessScopes="businessScope" v-bind:ids="id" />
	</div>
</template>
