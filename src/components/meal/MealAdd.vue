...
//			},
			...
			huixian: function(data) {
	           ...
	           if(this.isService == '0') {
	           	for(let i in data) {
	           		 data[i]['ordertypes']=this.isService
...
//						var t = nTrs[i]
//						goodsIDs.push(t.goodsID);
//						type.push(this.isService);
//					}
					//let orderTypes = [];
					...
					for(let i in this.list) {
						...
						orderTypes.push(this.list[i].ordertypes)
...
<style>
	...
	#modal-body .el-table--scrollable-y .el-table__body-wrapper{
