							...
							<el-table ref="multipleTable" :data="servList" height="300" tooltip-effect="dark" style="width: 100%">
								...
								<el-table-column prop="orderSum" label="原价小计" show-overflow-tooltip>
									<template slot-scope="scope">
										...
										<el-input id="allyuanjia" v-model="servList[scope.$index].orderSum" name="oldSum" disabled="disabled">
										</el-input>
										<!--<p style="display: none;" v-model="mealups.mesum"></p>-->
									</template>
								</el-table-column>
								<el-table-column prop="useEndTimeSum" label="套餐价小计" show-overflow-tooltip>
									<template slot-scope="scope">
										...
										<el-input id="alltao" v-model="servList[scope.$index].mealSum" name="mealSum" disabled="disabled">
										</el-input>
										<!--<p style="display: none;" v-model="mealups.dosum"></p>-->
									</template>
								</el-table-column>
