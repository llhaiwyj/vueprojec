						...
						<el-row :gutter="10">
							<el-col class="row reformbox" :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
							 ...
							 <el-col :span="7" class="gutterspan">
								 ...
								 <el-input @blur="test" v-model="usinfor.bussinessID" @change="selectFlag('1')" class="name1" clearable>
								 </el-input>
								  </div>
							  ...
							  <el-col :span="7" class="gutterspan">
								...
								<el-input @blur="test" v-model="usinfor.bussinessLinkPerson" class="name1"   @change="checkeds"
								 clearable>
								 </el-input>
								  </div>
							  ...
							  <el-col :span="7" class="gutterspan">
								...
								<el-input @blur="test" v-model="usinfor.phoneNum" class="name1" clearable @change="checkeds">
								 </el-input>
								  </div>
							  ...
							  <el-col :span="7" class="gutterspan">
							  	<div class="box">
							   	<div class="form-group" v-bind:class="{'form-group--error': $v.usinfor.scopeId.$error }">
								...
								<span class="form-group__message" v-if="!$v.usinfor.scopeId.required">不能为空</span>								
								</div>
							  </el-col>	
							   <el-col :span="7" class="gutterspan">
							   	<div class="box">
							  ...
							  <el-col :span="7" class="gutterspan">
								...
								<el-select @blur="test" class="xl" v-model="usinfor.isFormal" @change="checkFlag($event)">
							...
							<el-col :span="7" class="gutterspan" >
								...
								<el-input @blur="test" v-model="usinfor.wxappid" class="name1" clearable @change="checkeds">
								 </el-input>
								 </div>
								<span class="form-group__message" v-if="!$v.usinfor.wxappid.required">不能为空</span>								
								</div>
							</el-col>							 
							  <el-col :span="7" class="gutterspan">
							  	<div class="box">
								...
								<el-input  @blur="test" v-model="usinfor.wxtoken" class="name1" clearable @change="checkeds">
								 </el-input>
								 </div>
								<span class="form-group__message" v-if="!$v.usinfor.wxtoken.required">不能为空</span>								
								</div>
							 </el-col>
							 <el-col :span="7" class="gutterspan">
							 	<div class="box">
							   	<div class="form-group" v-bind:class="{'form-group--error': $v.usinfor.wxmch_id.$error }">
							 	<span class="mc">微信支付ID：</span>
								<el-input @blur="test" v-model="usinfor.wxmch_id" class="name1" clearable @change="checkeds">
								 </el-input>
								  </div>
								<span class="form-group__message" v-if="!$v.usinfor.wxmch_id.required">不能为空</span>								
								</div>
							 </el-col>
							 <!--上传文件-->
							  <el-col :span="7" class="gutterspan">
							...
							<el-col :span="7" class="gutterspan">
								<div class="box">
							   	<div class="form-group" v-bind:class="{'form-group--error': $v.usinfor.zfbapp_id.$error }">
							 	<span class="mc">支付宝号pid：</span>
								<el-input @blur="test" v-model="usinfor.zfbapp_id" class="name1" clearable @change="checkeds">
								 </el-input>
								 </div>
								<span class="form-group__message" v-if="!$v.usinfor.zfbapp_id.required">不能为空</span>								
								</div>
							 </el-col>
							 <el-col :span="7" class="gutterspan">
							 	<div class="box">
								...
								<el-input @blur="test" v-model="usinfor.zfbprivateKey" class="name1" clearable @change="checkeds">
								 </el-input>
								  </div>
								<span class="form-group__message" v-if="!$v.usinfor.zfbprivateKey.required">不能为空</span>								
								</div>
							 </el-col>							 
						</el-row>
...
//			}
		...
		methods: {
				...
				this.$v.usinfor.bussinessID.$touch()
             	...
             	this.$v.usinfor.wxmch_id.$touch()
             	if(this.$v.usinfor.wxmch_id.$error){
					return false;
				}
             	this.$v.usinfor.zfbapp_id.$touch()
             	if(this.$v.usinfor.zfbapp_id.$error){
					return false;
				}
             	...
             	this.$v.usinfor.scopeId.$touch()
             	if(this.$v.usinfor.scopeId.$error){
					return false;
				}
             	this.$v.usinfor.countryID.$touch()
             	if(this.$v.countryID.$error){
					return false;
				}
             	...
             	if(this.$v.usinfor.proves.$error){
					return false;
				}
             	return true;
			},
