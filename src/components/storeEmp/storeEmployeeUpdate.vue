						...
						<el-row :gutter="10">
							<el-col :span="10" class="gutterspan">
								<div class="box">
									...
									<el-input v-model="emp.employeeName" class="name1" disabled="disabled">
									</el-input>
									<!--</div>
							...
							<el-col :span="10" class="gutterspan">
								<div class="box">
									...
									<el-input v-model="emp.bussinessName" class="name1" disabled="disabled">
									</el-input>
							...
							<el-col :span="10" class="gutterspan">
								<div class="box">
									...
									<el-input v-model="emp.storeName" class="name1" disabled="disabled">
									</el-input>
							...
							<el-col :span="10" class="gutterspan">
								<div class="box">
									...
									<el-input v-model="emp.employeeCode" class="name1" @change="selectFlag('1')" disabled="disabled">
									</el-input>
									<!--</div>
							...
							<el-col :span="10" class="gutterspan">
								<div class="box">
									<!--<div class="form-group" v-bind:class="{'form-group--error': $v.emp.identity.$error }">-->
										...
										<el-input v-model="emp.identity" class="name1" @change="selectFlag('2')" disabled="disabled">
										</el-input>
									<!--</div>
							...
							<el-col :span="10" class="gutterspan">
								...
								<!--	<div class="form-group" v-bind:class="{'form-group--error': $v.emp.employeeSex.$error }">-->
										...
										<el-select class="xl" v-model="emp.employeeSex" disabled="disabled">
							...
							<el-col :span="10" class="gutterspan">
								<div class="box">
									...
									<el-date-picker class="xl" placeholder="" v-model="emp.employeeBirthday" format="yyyy-MM-dd" disabled="disabled">
									</el-date-picker>
									<!--</div>
...
<script>
	...
	export default {
		props: ['emp', 'state', 'employeeID', 'position', 'lists'],
		data() {
			return {
